...
function BlogPostPageContent({ sidebar, children }) {
  ...
  useEffect(() => {
    ...
    s.setAttribute("data-repo", "cloudmoonocus/my-website-cloudmoon");
    s.setAttribute("data-repo-id", "R_kgDOKW3EYA");
    s.setAttribute("data-category", "Announcements");
    s.setAttribute("data-category-id", "DIC_kwDOKW3EYM4Cb_G6");
